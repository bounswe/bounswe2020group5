...
from ..serializers import FavoriteListSerializer, FavoritesAddOrRemoveProductSerializer, FavoritesResponseSerializer, ResponseSerializer
from ..models import Product, Customer, FavoriteList
