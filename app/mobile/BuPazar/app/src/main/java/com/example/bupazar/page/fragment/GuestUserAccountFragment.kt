 ...
 * Use the [GuestUserAccountFragment.newInstance] factory method to
...
class GuestUserAccountFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment GuestUserAccountFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                GuestUserAccountFragment().apply {
